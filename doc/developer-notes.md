...
H2O Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as H2O Core, where everyone uses
...
pay attention to for reviewers of H2O Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: H2O Core uses tinyformat, which is type safe. Leave them out to avoid confusion
