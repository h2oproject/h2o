...
This mechanism has been integrated into Bitcore-Node-H2O which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/h2ocoin/insight-api-h2o#web-socket-api](https://github.com/h2ocoin/insight-api-h2o#web-socket-api) 
* API: [https://github.com/h2ocoin/insight-api-h2o#instantsend-transactions](https://github.com/h2ocoin/insight-api-h2o#instantsend-transactions) 
...
By default, the H2O Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the H2O Core daemon:
