...
Only requiring some minor changes is h2o.cpp.
...
Changes to h2o.cpp
----------------------
h2o.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
