    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("H2O Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About H2O Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  h2o-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the H2O in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 H2O, 0.1 H2O, 1 H2O and 10 H2O -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("H2O Core is shutting down...") + "<br /><br />" +
