    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("H2O-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("H2O-light"), QVariant("light"));
    ui->theme->addItem(QString("H2O-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("H2O-traditional"), QVariant("trad"));
