    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("H2O Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a H2O address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and h2o: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About H2O Core"), this);
    aboutAction->setStatusTip(tr("Show information about H2O Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for H2O Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your H2O addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified H2O addresses"));
    ...
    openAction->setStatusTip(tr("Open a h2o: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the H2O Core help message to get a list with possible H2O Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("H2O Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to H2O network", "", count));
}
...
{
    QString strTitle = tr("H2O Core"); // default title
