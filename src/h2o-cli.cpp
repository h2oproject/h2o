...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("H2O Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  h2o-cli [options] <command> [params]  " + _("Send command to H2O Core") + "\n" +
                  "  h2o-cli [options] help                " + _("List commands") + "\n" +
                  "  h2o-cli [options] help <command>      " + _("Get help for a command") + "\n";
