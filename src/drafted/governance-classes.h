 ...
 *
 *   // network
 *   CH2ONetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.h2o.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CH2ONetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: H2ONetwork
// //   -- signature requirements : Key1(User)
// class CH2ONetworkVariable : public CGovernanceObject
// {
// private:
